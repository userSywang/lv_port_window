...
void AppVideoPlayer::app_show_ui(void)
{
    ...
    lv_obj_set_size(cont_col, _height, _width);
    ...
    lv_obj_set_size(cont_row, _height - 20, 80);
    ...
    lv_obj_set_width(lbl_breaking_news,  _height - 155);
